...
/**
 *  Optimal Constant Weight algo. Should be better than Per Item Average.
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ $Log: OptimalConstantWeight.java,v $
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Revision 1.4  2003/11/24 16:26:29  lemired
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Removed data package again
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Revision 1.3  2003/11/17 18:43:07  lemired
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Added new BiRuleOf3
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Revision 1.2  2003/11/11 13:25:58  lemired
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Added gpl headers
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Revision 1.1  2003/11/03 23:41:57  lemired
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $ Latest changes: should almost conclude paper with Anna.
 *  $Id: OptimalConstantWeight.java,v 1.4 2003/11/24 16:26:29 lemired Exp $ $Date: 2003/11/24 16:26:29 $ $Revision: 1.4 $
 *
 ...
 *@since      July 2003
 */
public class OptimalConstantWeight extends PerItemAverage {
  /**
   ...
   */
  public OptimalConstantWeight( EvaluationSet set/*, float gamma*/) {
    super( set );
    //mGamma = gamma;
    computeWeights();
  }
  ...
  protected void computeWeights() {
    ...
    for ( int k = 0; k < mMaxItemID; ++k ) {
      System.out.println("OptimalConstantWeight k = "+k+ " mMaxItemID = "+ mMaxItemID);
  ...
  public String toString() {
    return "OptimalConstantWeight";//_mGamma_"+mGamma;
  }
